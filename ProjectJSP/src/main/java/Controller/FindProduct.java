...
public class FindProduct {
    ...
    public static Product findProduct(String id) throws SQLException, ClassNotFoundException {
    ...
    public static ArrayList<Item> initCart(String cartID) throws SQLException, ClassNotFoundException {
        ConnectionDB.connect();
    ...
    public static void updateDB(String cartid,Item item) throws SQLException, ClassNotFoundException {
        ConnectionDB.connect();
