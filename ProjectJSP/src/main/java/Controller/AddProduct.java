...
public class AddProduct extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String link = "";
            System.out.println("http://localhost:8080/ProjectJSP/assets/images/products/" + link);
            link += "http://localhost:8080/ProjectJSP/assets/images/products/" + request.getParameter("file");
