        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li>
                            <a href="danhsachctv.jsp">Danh sách CTV</a>
                        </li>

                        <li>
                            <a href="baocaodanhthutv.jsp">Báo cáo doanh thu CTV</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li>
                            <a href="pages-404.jsp">Sửa thông tin</a>
                        </li>
                        <li>
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li>
                            <a href="pages-404.jsp">Bảng tổng hợp</a>
                        </li>
                        <li>
                ...
                <li>
                    <a href="pages-404.jsp" class="waves-effect">
