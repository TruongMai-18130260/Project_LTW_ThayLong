                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div class="form-group mb-3">
                                                                        ...
                                                                        <input type="text" id="product-name" class="form-control" placeholder="e.g : Bàn ghế Baya" name="name">
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div class="form-group mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" id="product-price" placeholder="Điền giá" name="price">
                                                                    </div>
                                                                    <div class="form-group mb-3">
                                                                        <label for="product-price">Giá đã sale <span class="text-danger">*</span></label>
                                                                        <input type="text" class="form-control" id="product-saleprice" placeholder="Điền giá" name="saleprice">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    ...
                                                                    <form action="ABC" method="post" class="dropzone" id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate">
                                                                        <div class="fallback">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="text-center">
                                                            ...
                                                            <button  type="submit" class="btn btn-success waves-effect waves-light btn-sm"> Xác Nhận</button>
