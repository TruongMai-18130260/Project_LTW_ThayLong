                        ...
                        <div class="card-box">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="settings">
                                    <form action="http://localhost:8080/ProjectJSP/ABC" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="adminname" placeholder="Nhập tên" name="name" value="${sessionScope.user.name}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="phone">Số điện thoại</label>
                                                    <input type="text" class="form-control" id="phone" placeholder="Nhập sđt" name="phone" value="${sessionScope.user.phone}">
                                                </div>
                                            </div>
                                            <!-- end col -->
                                        </div> <!-- end row -->
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="adminaddress" rows="4" placeholder="Viet Nam" name="address" value="${sessionScope.user.address}"></textarea>
                                                </div>
                                            </div> <!-- end col -->
                                        </div> <!-- end row -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" id="adminemail" placeholder="Nhập email" name="email" value="${sessionScope.user.email}" disabled>
