...
<div class="body-content">
    ...
    <div class="contact-page">
		<div class="row">
				...
				<div class="col-md-12 contact-map outer-bottom-vs">
					<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31346.777421984974!2d106.77124777642109!3d10.86117670198758!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3175276398969f7b%3A0x9672b7efd0893fc4!2zxJDhuqFpIEjhu41jIE7DtG5nIEzDom0!5e0!3m2!1svi!2s!4v1604159683286!5m2!1svi!2s" width="600" height="450" style="border:0"></iframe>
				</div>
	...
	<div class="col-md-4">
		<form class="register-form" role="form">
		    ...
		    <input type="email" class="form-control unicase-form-control text-input" id="exampleInputTitle" placeholder="Tiêu đề">
		  </div>
		</form>
	</div>
	<div class="col-md-12">
		<form class="register-form" role="form">
			<div class="form-group">
		    <label class="info-title" for="exampleInputComments">Ý kiến của bạn <span>*</span></label>
...
<div class="col-md-3 contact-info">
	...
	<div class="clearfix phone-no">
		...
		<span class="contact-span">+(84)(39)798-7561<br>+(84)(39)798-7561</span>
	</div>
	<div class="clearfix email">
		<span class="contact-i"><i class="fa fa-envelope"></i></span>
		<span class="contact-span"><a href="#">minhq460@gmail.com</a></span>
	</div>
			...
			<div class="module-body">
			  <ul class="toggle-footer">
				...
				<li class="media">
				  ...
				  <div class="media-body"> <span><a href="#">minhq460@gmail.com</a></span> </div>
				</li>
			  </ul>
			</div>
			<!-- /.module-body --> 
	...
	<div class="copyright-bar">
	  <div class="container">
		<div class="col-xs-12 col-sm-6 no-padding social">
		  <ul class="link">
			<li class="fb pull-left"><a target="_blank" rel="nofollow" href="http://www.facebook.com" title="Facebook"></a></li>
			<li class="tw pull-left"><a target="_blank" rel="nofollow" href="http://www.twitter.com" title="Twitter"></a></li>
			<li class="googleplus pull-left"><a target="_blank" rel="nofollow" href="http://www.google.com" title="GooglePlus"></a></li>
			<li class="rss pull-left"><a target="_blank" rel="nofollow" href="https://rss.com/" title="RSS"></a></li>
			<li class="pinterest pull-left"><a target="_blank" rel="nofollow" href="https://www.pinterest.com" title="PInterest"></a></li>
