...
<div class="body-content">
	<div class="container">
		<div class="row">
			<div class="blog-page">
				<div class="col-md-9">
					<c:forEach var="item" items="${sessionScope.listBlog}">
						<div class="blog-post  wow fadeInUp">
							<a href="BlogDetail?blogid=${item.blogid}"><img class="img-responsive" src="${item.thumbnailURL}" alt="" style="width: 806px;
							height: 400px;"></a>
							<h1><a href="BlogDetail?blogid=${item.blogid}">${item.title}</a></h1>
							<span class="author">${item.username}</span>
							<span class="review">6 Bình luận</span>
							<span class="date-time">14/06/2019 10.00AM</span>
							<p>${item.smallcontent}</p>
							<a href="BlogDetail?blogid=${item.blogid}" class="btn btn-upper btn-primary read-more">Đọc thêm</a>
						</div>
					</c:forEach>
