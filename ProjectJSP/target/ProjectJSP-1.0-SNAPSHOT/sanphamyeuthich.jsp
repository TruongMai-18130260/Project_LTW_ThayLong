		...
		<table class="table">
			...
			<tbody>
				<tr>
					...
					<td class="col-md-7">
						<div class="product-name"><a href="#">Combo phòng khách CARINRE
						</a></div>
						<div class="rating">
				...
				<tr>
					...
					<td class="col-md-7">
						<div class="product-name"><a href="#">Ghế đôn</a></div>
						<div class="rating">
							<i class="fa fa-star rate"></i>
							<i class="fa fa-star rate"></i>
							<i class="fa fa-star rate"></i>
				...
				<tr>
					<td class="col-md-2"><img src="assets\images/furnitures/light/3.jpg" alt="img"></td>
					<td class="col-md-7">
						<div class="product-name"><a href="#">Đèn PARKER
						</a></div>
						<div class="rating">
							<i class="fa fa-star rate"></i>
							<i class="fa fa-star rate"></i>
				...
				<tr>
					<td class="col-md-2"><img src="assets\images/furnitures/shelf/1.jpg" alt="imga"></td>
					<td class="col-md-7">
						<div class="product-name"><a href="#">Kệ sách BABILON
						</a></div>
						<div class="rating">
							<i class="fa fa-star rate"></i>
							<i class="fa fa-star rate"></i>
