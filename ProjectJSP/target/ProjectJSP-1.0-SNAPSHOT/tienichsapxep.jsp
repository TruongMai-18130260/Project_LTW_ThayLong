...
<title>BAYA | TIỆN ÍCH SẮP XẾP</title>
  ...
  <div class="container">
    <div class="breadcrumb-inner">
      <ul class="list-inline list-unstyled">
        ...
        <li class='active' style="padding-right: 0px;width: 115px;">Tiện ích sắp xếp</li>
      </ul>
    </div>
    <!-- /.breadcrumb-inner --> 
  </div>
          ...
          <div class="item">
            ...
            <div class="container-fluid">
              <div class="caption vertical-top text-left">
                <div class="big-text" style="font-size: 50px;"> Tiện ích sắp xếp </div>
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="assets\images\products/sapxep1.jpg"></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html">GIÁ ĐỰNG TÀI LIỆU
                            TRAMP</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> 79.000đ </span> <span class="price-before-discount">100.000đ</span> </div>
                          <!-- /.product-price --> 
