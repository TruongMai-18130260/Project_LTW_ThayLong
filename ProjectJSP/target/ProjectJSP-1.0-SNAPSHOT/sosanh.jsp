		...
		<div>
			...
			<div class="table-responsive">
				<table class="table compare-table inner-top-vs">
							...
							<div class="product">
								<div class="product-image">
									...
									<div class="product-info text-left">
										<h3 class="name"><a href="detail.html">COMBO PHÒNG KHÁCH CARINE</a></h3>
										<div class="action">
										    <a class="lnk btn btn-primary" href="#">Thêm vào giỏ hàng</a>
										</div>
						...
						<td>
							<div class="product">
								<div class="product-image">
									...
									<div class="product-info text-left">
										<h3 class="name"><a href="detail.html">COMBO PHÒNG KHÁCH
											ACCORD
										</a></h3>
										<div class="action">
										    <a class="lnk btn btn-primary" href="#">Thêm vào giỏ hàng</a>
						...
						<td>
							<div class="product">
								<div class="product-image">
									<div class="image">
										<a href="detail.html">
										    <img alt="" src="assets\images\products/noithatgo2.jpg">
										</a>
									</div>
						...
						<td>
							<div class="product">
								<div class="product-image">
									<div class="image">
										<a href="detail.html">
										    <img alt="" src="assets\images\products/noithatgo5.jpg">
										</a>
									</div>

									<div class="product-info text-left">
										<h3 class="name"><a href="detail.html">BỘ BÀN & GHẾ VĂN PHÒNG
											ACADEMY</a></h3>
										<div class="action">
										    <a class="lnk btn btn-primary" href="#">Thêm vào giỏ hàng</a>
										</div>
					...
					<tr>
						...
						<td>
							<div class="product-price">
								<span class="price"> 13.500.000đ </span>
								<span class="price-before-discount">14.000.000đ</span>
							</div>
						</td>
						...
						<td>
							<div class="product-price">
								...
								<span class="price-before-discount">11.500.000đ</span>
							</div>
						</td>
						...
						<td>
							<div class="product-price">
								...
								<span class="price-before-discount">12.800.000đ</span>
							</div>
						</td>

						<td>
							<div class="product-price">
								<span class="price"> 7.869.000đ </span>
								<span class="price-before-discount">8.500.000đ</span>
							</div>
						</td>
					</tr>
					...
					<tr>
						 <th>Trạng thái</th>
	                     <td><p class="in-stock">Còn hàng</p></td>
	                     <td><p class="in-stock"	>Còn hàng</p></td>
	                     <td><p class="in-stock">Còn hàng</p></td>
	                     <td><p class="in-stock">Còn hàng</p></td>
					</tr>
