  ...
  <div class="container">
    <div class="breadcrumb-inner">
      <ul class="list-inline list-unstyled">
        ...
        <li class='active'>Phòng trẻ em</li>
      </ul>
    </div>
    <!-- /.breadcrumb-inner --> 
  </div>
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="assets/images/furnitures/chair/4.jpg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html">Ghế trẻ em</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> 550,000đ </span> <span class="price-before-discount">600,000đ</span> </div>
                          <!-- /.product-price --> 
                    ...
                    <div class="product-list product">
                      <div class="row product-list-row">
                        <div class="col col-sm-4 col-lg-4">
                          <div class="product-image">
                            <div class="image"> <img src="assets/images/furnitures/bed/2.jpg" alt=""> </div>
                          </div>
                          <!-- /.product-image --> 
                        </div>
                        <!-- /.col -->
                        <div class="col col-sm-8 col-lg-8">
                          <div class="product-info">
                            <h3 class="name"><a href="detail.html">Giường tầng Gravity</a></h3>
                            <div class="rating rateit-small"></div>
                            <div class="product-price"> <span class="price"> 4,490,000đ </span> <span class="price-before-discount">4,600,000đ</span> </div>
                            <!-- /.product-price -->
                            <div class="description m-t-10">Giường tầng cho trẻ từ 6 đến 14 tuổi</div>
                            <div class="cart clearfix animate-effect">
                              <div class="action">
                                <ul class="list-unstyled">
                                  <li class="add-cart-button btn-group">
