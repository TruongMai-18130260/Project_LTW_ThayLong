          ...
          <div class="item">
            ...
            <div class="container-fluid">
              <div class="caption vertical-top text-left">
                <div class="big-text"> Phòng khách </div>
                      ...
                      <div class="row product-list-row">
                        ...
                        <div class="col col-sm-8 col-lg-8">
                          <div class="product-info">
                            <h3 class="name"><a href="detail.html">Ghế cao trắng</a></h3>
                            <div class="rating rateit-small"></div>
                            <div class="product-price"> <span class="price"> 350,000đ </span> </div>
                            <!-- /.product-price -->
                            <div class="description m-t-10">Ghế cao với chất liệu nhựa cao cấp dùng để trang trí phòng khách tạo cảm giác thoải mái và thư giản khi ngồi</div>
                            <div class="cart clearfix animate-effect">
                              <div class="action">
                                <ul class="list-unstyled">
                                  <li class="add-cart-button btn-group">
                  ...
                  <div class="products">
                    <div class="product-list product">
                      <div class="row product-list-row">
                        ...
                        <div class="col col-sm-8 col-lg-8">
                          <div class="product-info">
                            <h3 class="name"><a href="detail.html">Ghế gia đình</a></h3>
                            <div class="rating rateit-small"></div>
                            <div class="product-price"> <span class="price"> 350,000đ </span> </div>
                            <!-- /.product-price -->
                            <div class="description m-t-10">Ghế cao với chất liệu nhựa cao cấp dùng để trang trí phòng khách tạo cảm giác thoải mái và thư giản khi ngồi</div>
                  ...
                  <div class="products">
                    <div class="product-list product">
                      <div class="row product-list-row">
                        ...
                        <div class="col col-sm-8 col-lg-8">
                          <div class="product-info">
                            <h3 class="name"><a href="detail.html">Ghê gia đình</a></h3>
                            <div class="rating rateit-small"></div>
                            <div class="product-price"> <span class="price"> 13,350,000đ </span> </div>
                            <!-- /.product-price -->
                            <div class="description m-t-10">Ghế cao với chất liệu nhựa cao cấp dùng để trang trí phòng khách tạo cảm giác thoải mái và thư giản khi ngồi</div>
                            <div class="cart clearfix animate-effect">
                              <div class="action">
                  ...
                  <div class="products">
                    <div class="product-list product">
                      <div class="row product-list-row">
                        ...
                        <div class="col col-sm-8 col-lg-8">
                          <div class="product-info">
                            <h3 class="name"><a href="detail.html">Ghế Darius</a></h3>
                            <div class="rating rateit-small"></div>
                            <div class="product-price"> <span class="price"> 2,350,000đ </span> </div>
                            <!-- /.product-price -->
                            <div class="description m-t-10">Ghế cao với chất liệu nhựa cao cấp dùng để trang trí phòng khách tạo cảm giác thoải mái và thư giản khi ngồi</div>
                            <div class="cart clearfix animate-effect">
                              <div class="action">
                  ...
                  <div class="products">
                    <div class="product-list product">
                      <div class="row product-list-row">
                        ...
                        <div class="col col-sm-8 col-lg-8">
                          <div class="product-info">
                            <h3 class="name"><a href="detail.html">Ghế Oriana</a></h3>
                            <div class="rating rateit-small"></div>
                            <div class="product-price"> <span class="price"> 250,000đ </span> </div>
                            <!-- /.product-price -->
                            <div class="description m-t-10">Ghế cao với chất liệu nhựa cao cấp dùng để trang trí phòng khách tạo cảm giác thoải mái và thư giản khi ngồi</div>
                            <div class="cart clearfix animate-effect">
                              <div class="action">
                  ...
                  <div class="products">
                    <div class="product-list product">
                      <div class="row product-list-row">
                        ...
                        <div class="col col-sm-8 col-lg-8">
                          <div class="product-info">
                            <h3 class="name"><a href="detail.html">Ghế gia đình Zed</a></h3>
                            <div class="rating rateit-small"></div>
                            <div class="product-price"> <span class="price"> 13,350,000đ </span> </div>
                            <!-- /.product-price -->
                            <div class="description m-t-10">Ghế cao với chất liệu nhựa cao cấp dùng để trang trí phòng khách tạo cảm giác thoải mái và thư giản khi ngồi</div>
                  ...
                  <div class="products">
                    <div class="product-list product">
                      <div class="row product-list-row">
                        ...
                        <div class="col col-sm-8 col-lg-8">
                          <div class="product-info">
                            <h3 class="name"><a href="detail.html">Ghế Demacia</a></h3>
                            <div class="rating rateit-small"></div>
                            <div class="product-price"> <span class="price"> 750,000đ </span> </div>
                            <!-- /.product-price -->
                            <div class="description m-t-10">Ghế cao với chất liệu nhựa cao cấp dùng để trang trí phòng khách tạo cảm giác thoải mái và thư giản khi ngồi</div>
                            <div class="cart clearfix animate-effect">
                              <div class="action">
                  ...
                  <div class="products">
                    <div class="product-list product">
                      <div class="row product-list-row">
                        ...
                        <div class="col col-sm-8 col-lg-8">
                          <div class="product-info">
                            <h3 class="name"><a href="detail.html">Ghế Zac</a></h3>
                            <div class="rating rateit-small"></div>
                            <div class="product-price"> <span class="price"> 950,000đ </span> </div>
                            <!-- /.product-price -->
                            <div class="description m-t-10">Ghế cao với chất liệu nhựa cao cấp dùng để trang trí phòng khách tạo cảm giác thoải mái và thư giản khi ngồi</div>
                            <div class="cart clearfix animate-effect">
                              <div class="action">
                  ...
                  <div class="products">
                    <div class="product-list product">
                      <div class="row product-list-row">
                        ...
                        <div class="col col-sm-8 col-lg-8">
                          <div class="product-info">
                            <h3 class="name"><a href="detail.html">Bàn gia đình</a></h3>
                            <div class="rating rateit-small"></div>
                            <div class="product-price"> <span class="price"> 3,350,000đ </span> </div>
                            <!-- /.product-price -->
                            <div class="description m-t-10">Ghế cao với chất liệu nhựa cao cấp dùng để trang trí phòng khách tạo cảm giác thoải mái và thư giản khi ngồi</div>
                            <div class="cart clearfix animate-effect">
                              <div class="action">
                  ...
                  <div class="products">
                    <div class="product-list product">
                      <div class="row product-list-row">
                        ...
                        <div class="col col-sm-8 col-lg-8">
                          <div class="product-info">
                            <h3 class="name"><a href="detail.html">Đồng hồ Warwick</a></h3>
                            <div class="rating rateit-small"></div>
                  ...
                  <div class="products">
                    <div class="product-list product">
                      <div class="row product-list-row">
                        ...
                        <div class="col col-sm-8 col-lg-8">
                          <div class="product-info">
                            <h3 class="name"><a href="detail.html">Đèn Bard</a></h3>
                            <div class="rating rateit-small"></div>
                            <div class="product-price"> <span class="price"> 350,000đ </span> </div>
                            <!-- /.product-price -->
                            <div class="description m-t-10">Ghế cao với chất liệu nhựa cao cấp dùng để trang trí phòng khách tạo cảm giác thoải mái và thư giản khi ngồi</div>
