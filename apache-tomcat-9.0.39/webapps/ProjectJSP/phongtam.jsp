                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="assets/images/furnitures/hook/2.jpg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html">Khay đựng vật dụng phòng tắm Sandra</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> 99,000đ </span> <span class="price-before-discount">115,000đ</span> </div>
                          <!-- /.product-price --> 
                    ...
                    <div class="product-list product">
                      <div class="row product-list-row">
                        <div class="col col-sm-4 col-lg-4">
                          <div class="product-image">
                            <div class="image"> <img src="assets/images/furnitures/hook/3.jpg" alt=""> </div>
                          </div>
                          <!-- /.product-image --> 
                        </div>
                        <!-- /.col -->
                        <div class="col col-sm-8 col-lg-8">
                          <div class="product-info">
                            <h3 class="name"><a href="detail.html">Giá treo khăn</a></h3>
                            <div class="rating rateit-small"></div>
                            <div class="product-price"> <span class="price"> 169,000đ </span></div>
                            <!-- /.product-price -->
                            <div class="description m-t-10">Với vật liệu inox, giá treo tạo giác chaswsc chắn và sang trọng cho phòng tắm</div>
                            <div class="cart clearfix animate-effect">
                              <div class="action">
                                <ul class="list-unstyled">
                                  <li class="add-cart-button btn-group">
