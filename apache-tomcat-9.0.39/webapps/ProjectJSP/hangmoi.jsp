...
<div class="body-content outer-top-xs">
  <div class='container'>
      ...
      <div class='col-md-3 sidebar'> 
       ...
       <jsp:include page="sidebar-left.jsp"/>
        ...
        <!-- ============================================== Testimonials: END ============================================== -->
            ...
            <div class="home-banner"> <img src="assets/images/banners/slide-banner2.jpg" alt="Image" style="
              width: 264px;
              height: 180px;
          "> </div>
          </div>
    ...
    margin-bottom: 17px;">HÀNG MỚI VỀ</h2>
         <h2 style="text-align: center;text-align: center;
         margin-bottom: 17px;">BỘ SƯU TẬP CARINE - KHI THẨM MỸ CHẠM ĐẾN TÍNH NĂNG</h2>
           <div style=" width: 1070px;
           margin: 15px;">
           <img src="assets/images/banners/bst-CARINE-baya-1.jpg" alt="Image" style="float: left; padding: 10px;
           width: 410px;">
           <img src="assets/images/banners/bst-CARINE-baya-2.jpg" alt="Image" style="float: left; padding: 10px;
           
           width: 410px;">
           
           </div>
            <p style="font-size: 16px;text-align: left;margin-left: 2rem;font-weight: 600;">- Giản đơn chính là sự che giấu những điều không cần thiết, chỉ để lại vẻ bề ngoài gọn gàng và một không gian thoáng đãng.</p>

            <p style="font-size: 16px;text-align: left;margin-left: 2rem;font-weight: 600;">- Đó cũng chính là điều mà các nhà thiết kế của BAYA muốn gửi gắm đến quý khách qua bộ sưu tập CARINE mà chúng tôi vẫn luôn ấp ủ bấy lâu. Các sản phẩm trong bộ sưu tập hướng đến việc tối ưu không gian phòng khách nhờ vào các ngăn kéo và hộc tủ rộng rãi.</p>
            
            <p style="font-size: 16px;text-align: left;margin-left: 2rem;font-weight: 600;">- Bên cạnh đó, màu sáng tự nhiên của gỗ sồi veneer, lớp phủ MDF và thiết kế trẻ trung, giản đơn, bộ sưu tập CARINE mang đến cho không gian tổ ấm nhà bạn cảm giác êm dịu, giúp tâm trí dễ dàng thư giãn hơn.</p>
            
            <p style="font-size: 16px;text-align: left;margin-left: 2rem;font-weight: 600;">- Bộ sưu tập CARINE gồm: giường, tủ quần áo, tủ đầu giường, tủ ngăn kéo, bàn trang điểm, bàn cà phê, bàn góc, và kệ TV.</p>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="assets/images/hangmoi/carine_bed_baya_5271.jpg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html">GIƯỜNG</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> 8.890.000đ </span>  </div>
                          <!-- /.product-price --> 
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="assets/images/hangmoi/carine_bedside_table_baya_5274.jpg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html">TỦ ĐẦU GIƯỜNG</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price">5.500.000đ </span>  </div>
                          <!-- /.product-price --> 
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="assets/images/hangmoi/carine_chest_of_drawers_baya_5275.jpg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html">TỦ NGĂN KÉO</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> 6.490.000đ </span> </div>
                          <!-- /.product-price --> 
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="assets/images/hangmoi/carine_coffee_table_baya_5276.jpg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html">BÀN CÀ PHÊ</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> 3.200.000đ </span>  </div>
                          <!-- /.product-price --> 
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="assets/images/hangmoi/carine_side_table_baya_5277.jpg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html">BÀN GÓC</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> 4.500.000đ </span>  </div>
                          <!-- /.product-price --> 
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="assets/images/hangmoi/carine_tv_bench_baya_5278.jpg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html">KỆ TV</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> 7.500.000đ </span></div>
                          <!-- /.product-price --> 
