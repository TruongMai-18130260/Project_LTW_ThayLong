...
<div class="body-content outer-top-xs">
  <div class='container'>
    ...
    margin-bottom: 17px;">HOT DEALS</h2>
            ...
            <p style="font-size: 16px;text-align: left;margin-left: 2rem;font-weight: 600;">- Số lượng có hạn, chương trình có thể kết thúc sớm hơn dự kiến..</p>

            <p style="font-size: 16px;text-align: left;margin-left: 2rem;font-weight: 600;">- Giao hàng miễn phí trên toàn quốc với mọi giá trị đơn hàng.</p>
            
            <p style="font-size: 16px;text-align: left;margin-left: 2rem;font-weight: 600;">- Ưu đãi giảm giá không áp dụng cùng lúc với các chương trình khuyến mãi khác.</p>
            
            <p style="font-size: 16px;text-align: left;margin-left: 2rem;font-weight: 600;">- Không áp dụng chính sách đổi trả và bảo hành với những sản phẩm CLEARANCE.</p>

            <p style="font-size: 16px;text-align: left;margin-left: 2rem;font-weight: 600;">- Quý khách vui lòng liên hệ Hotline 1900 63 64 76 (phím 1) để biết thêm chi tiết.</p>
                ...
                <div class="row">
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="assets/images/hot-deals/hot-deals1.jpg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html">BỘ BÀN GHẾ GỖ HƯƠNG</a></h3>
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="assets/images/hot-deals/hot-deals2.jpg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html">GIƯỜNG HILUS</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="assets/images/hot-deals/hot-deals3.jpg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html">SOFA PHÒNG KHÁCH </a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> 8.490.000đ </span> </div>
                          <!-- /.product-price --> 
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html">KỆ LUXURY</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html">GIƯỜNG ALOHA</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html">ĐỒNG HỒ</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> 2.500.000đ </span></div>
                          <!-- /.product-price --> 
