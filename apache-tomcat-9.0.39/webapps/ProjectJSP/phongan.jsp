                    ...
                    <div class="products">
                      <div class="product">
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html">Combo bàn ăn</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price"> 15,000,000đ </span> <span class="price-before-discount">16,000,000đ</span> </div>
                          <!-- /.product-price --> 
                    ...
                    <div class="product-list product">
                      <div class="row product-list-row">
                        <div class="col col-sm-4 col-lg-4">
                          <div class="product-image">
                            <div class="image"> <img src="assets/images/furnitures/light/3.jpg" alt=""> </div>
                          </div>
                          <!-- /.product-image --> 
                        </div>
                        <!-- /.col -->
                        <div class="col col-sm-8 col-lg-8">
                          <div class="product-info">
                            <h3 class="name"><a href="detail.html">Đèn bếp</a></h3>
                            <div class="rating rateit-small"></div>
                            <div class="product-price"> <span class="price"> 100,000đ </span></div>
                            <!-- /.product-price -->
                            <div class="description m-t-10">đèn bếp luxury tạo cảm giác ấm cúng cho căn bếp của gia đình</div>
                            <div class="cart clearfix animate-effect">
                              <div class="action">
                                <ul class="list-unstyled">
                                  <li class="add-cart-button btn-group">
