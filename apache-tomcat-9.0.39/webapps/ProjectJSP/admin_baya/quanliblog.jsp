                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="text-lg-right">
                                                    <button type="button" class="btn btn-danger mb-2 mr-2"><i class="mdi mdi-basket mr-1"></i> Thêm blog mới</button>
                                            ...
                                            <table class="table table-centered table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="ecommerce-orders-detail.html" class="text-body font-weight-medium">#DM01</a> </td>
                                                        <td>Nội thất</td>
                                                        <th>Nội dung</th>
                                                        <th>Minh Romeo</th>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="ecommerce-orders-detail.html" class="text-body font-weight-medium">#DM02</a> </td>
