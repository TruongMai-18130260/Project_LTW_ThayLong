...
<html lang="en">
    ...
    <body>
        ...
        <!-- Flot js-->
        <script src="admin_baya/assets/libs/flot-charts/jquery.flot.js"></script>
        <script src="admin_baya/assets/libs/flot-charts/jquery.flot.time.js"></script>
        <script src="admin_baya/assets/libs/flot-charts/jquery.flot.tooltip.min.js"></script>
        <script src="admin_baya/assets/libs/flot-charts/jquery.flot.resize.js"></script>
        <script src="admin_baya/assets/libs/flot-charts/jquery.flot.pie.js"></script>
        <script src="admin_baya/assets/libs/flot-charts/jquery.flot.selection.js"></script>
        <script src="admin_baya/assets/libs/flot-charts/jquery.flot.stack.js"></script>
        <script src="admin_baya/assets/libs/flot-charts/jquery.flot.orderBars.js"></script>
        <script src="admin_baya/assets/libs/flot-charts/jquery.flot.crosshair.js"></script>

        <!-- init js -->
        <script src="admin_baya/assets/js/pages/flot.init.js"></script>
