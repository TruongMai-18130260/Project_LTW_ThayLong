                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="detail.html"><img src="assets/images/furnitures/oven/1.jpg" alt=""></a> </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="detail.html">Lò Nướng Texas</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price">999,000đ</span> <span class="price-before-discount">1,000,000</span> </div>
                          <!-- /.product-price --> 
                    ...
                    <div class="product-list product">
                      <div class="row product-list-row">
                        <div class="col col-sm-4 col-lg-4">
                          <div class="product-image">
                            <div class="image"> <img src="assets/images/furnitures/combo/2.jpg" alt=""> </div>
                          </div>
                          <!-- /.product-image --> 
                        </div>
                        <!-- /.col -->
                        <div class="col col-sm-8 col-lg-8">
                          <div class="product-info">
                            <h3 class="name"><a href="detail.html">Bộ bàn ghế ngoài trời Riven</a></h3>
                            <div class="rating rateit-small"></div>
                            <div class="product-price"> <span class="price"> 1,800,000đ </span> <span class="price-before-discount">2,100,000đ</span> </div>
                            <!-- /.product-price -->
                            <div class="description m-t-10">Bộ bàn ghế gỗ Riven phù hợp với sân rộng</div>
                            <div class="cart clearfix animate-effect">
                              <div class="action">
                                <ul class="list-unstyled">
                                  <li class="add-cart-button btn-group">
